  ...
  <footer id="colophon" class="site-footer" itemscope itemtype="https://schema.org/WPFooter">
      ...
      <div class="tc-wrapper">
        <div class="col">
          <section id="text-10" class="widget widget_text">
            <h2 class="widget-title rtl" style="text-align:right" itemprop="name">About Us</h2>
            <div class="textwidget rtl" style="text-align:right">
        ...
        <div class="col">
          <section id="text-7" class="widget widget_text">
            <h2 class="widget-title rtl" style="text-align:right" itemprop="name">تماس با من</h2>
            <div class="textwidget" style="text-align:right">
              <p>
                khashayar.mafi75@gmail.com
                <br />+989369370748
              </p>
            </div>
          </section>
        ...
        <div class="col">
          <section id="raratheme_recent_post-2" class="widget widget_raratheme_recent_post">
            <h2 class="widget-title rtl" style="text-align:right" itemprop="name">دسترسی سریع</h2>
            <nav
              id="site-navigatio"
              class="main-navigation rtl"
              itemscope
            ...
            >
              <ul id="primary-menu" class="nav-menu">
                <li
                  id="menu-item-123"
                  class="menu-item menu-item-type-post_type menu-item-object-page menu-item rtl"
                >
    ...
    <div class="bottom-footer">
      <div class="tc-wrapper">
        <div class="copyright">
          طراح سایت
          <a style="font-weight:600" href="https://www.khashayarmafi.ir">خشایار مافی</a>
        </div>
        <div class="foot-social">
          <ul class="social-icons">
            <li>
              <a href="https://www.github.com/camel-black" target="_blank" rel="nofollow">
            ...
            <li>
              <a href="https://t.me/kh_mfi" target="_blank" rel="nofollow">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="1 -35 511.99993 511" height="20">
                  <path
            ...
            <li>
              <a href="https://www.instagram.com/khashayar_mafi" target="_blank" rel="nofollow">
                <svg
